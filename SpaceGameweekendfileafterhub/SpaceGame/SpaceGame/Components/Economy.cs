...
namespace SpaceGame
{
    public class Economy
    {
        ...
        public int PlanetQuantity { get; set; }
        public int BuyingingPricce { get; set; }
        public int SellingPricce { get; set; }
        #endregion
        #region method
       ...
       */
        ...
        public void SellingPrice(int GetPriceResorceID)
        {
            ...
            SellingPricce = GetPriceResorceID + 1  - ( GetPriceResorceID * ( PlanetQuantity/20));
        }

        public void BuyingingPrice(int GetPriceResorceID)
        {
            BuyingingPricce = GetPriceResorceID + 1 + (GetPriceResorceID * (PlanetQuantity / 20));
        }
