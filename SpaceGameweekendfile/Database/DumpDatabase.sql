...
BEGIN TRANSACTION;
DROP TABLE SessionToPlanet;
DROP TABLE SessionToShip;
DROP TABLE SessionToResources;
DROP TABLE ResourcesMedia;
DROP TABLE ShipMedia;
DROP TABLE PlanetMedia;
DROP TABLE PlanetResources;
DROP TABLE ShipResource;
DROP TABLE Sessions;
