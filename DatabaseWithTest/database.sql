...
CREATE TABLE SessionToPlanet (
	...
	Session_id INTEGER,
	Planet_id INTEGER,
	CONSTRAINT fk_StP_Se FOREIGN KEY (Session_id) REFERENCES Users(Session_id),
...
CREATE TABLE SessionToShip (
	...
	Session_id INTEGER,
	Ship_id INTEGER,
	CONSTRAINT fk_StS_Session FOREIGN KEY (Session_id) REFERENCES Users(Session_id),
...
CREATE TABLE SessionToResources (
	...
	Session_id INTEGER,
	Resource_id INTEGER,
	CONSTRAINT fk_StR_Ses FOREIGN KEY (Session_id) REFERENCES Users(Session_id),
