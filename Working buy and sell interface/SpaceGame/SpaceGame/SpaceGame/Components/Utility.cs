...
namespace SpaceGame.Components
{
    class Utility
    {
        public static List<Resource> AddResource(List<Resource> baseResource, List<Resource> changeResource){
        ...
        public static List<Resource> RemoveResource(List<Resource> baseResource, List<Resource> changeResource)
        {
            Console.WriteLine("Resource");
            for (int i = 0; i < changeResource.Count; i++)
            {
